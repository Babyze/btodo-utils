...
__export(index_exports, {
  ...
  transformDataTogRPCData: () => transformDataTogRPCData,
  transformgRPCToData: () => transformgRPCToData
});
...
var import_typeorm = require("@nestjs/typeorm");
var _DatabaseModule_decorators, _init;
_DatabaseModule_decorators = [(0, import_common.Module)({})];
var DatabaseModule = class {
  static forFeature(models) {
    return import_typeorm.TypeOrmModule.forFeature(models);
  }
};
_init = __decoratorStart(null);
DatabaseModule = __decorateElement(_init, 0, "DatabaseModule", _DatabaseModule_decorators, DatabaseModule);
__runInitializers(_init, 1, DatabaseModule);

// lib/database/base.repository.ts
var import_typeorm2 = require("typeorm");
var BaseAbstractRepository = class extends import_typeorm2.Repository {
  constructor(repo) {
  ...
  createManyAndSave(data) {
    const object = this.repo.create(data);
    return this.repo.save(object);
  }
  findOneByCondition(filterCondition) {
...
var grpcCatchErrorOrDone = (func) => {
  return (0, import_rxjs.firstValueFrom)(
    func.pipe(
      (0, import_rxjs.map)((value) => transformgRPCToData(value)),
...
// lib/utils/grpc-status-to-http-code.util.ts
var import_grpc_js = require("@grpc/grpc-js");
var import_common2 = require("@nestjs/common");
var GrpcStatusToHttpCode = {
  [import_grpc_js.status.INVALID_ARGUMENT]: import_common2.HttpStatus.BAD_REQUEST,
  ...
  [import_grpc_js.status.ABORTED]: import_common2.HttpStatus.GONE,
  ...
  [import_grpc_js.status.UNAVAILABLE]: import_common2.HttpStatus.SERVICE_UNAVAILABLE,
  [import_grpc_js.status.DEADLINE_EXCEEDED]: import_common2.HttpStatus.GATEWAY_TIMEOUT,
  [import_grpc_js.status.OUT_OF_RANGE]: import_common2.HttpStatus.PAYLOAD_TOO_LARGE,
  [import_grpc_js.status.CANCELLED]: import_common2.HttpStatus.UNPROCESSABLE_ENTITY,
  [import_grpc_js.status.FAILED_PRECONDITION]: import_common2.HttpStatus.PRECONDITION_FAILED
};
...
var httpCatchErrorOrDone = (func) => {
  return (0, import_rxjs2.firstValueFrom)(
    func.pipe(
      (0, import_rxjs2.map)((value) => transformgRPCToData(value)),
...
var transformValue2 = (value) => {
  ...
  if (typeof value === "object") {
    const transformed = {};
    for (const key of Object.keys(value)) {
      transformed[key] = transformValue2(value[key]);
    }
    return transformed;
  }
  return value;
